...
variable "os_img-url" {
  ...
  default     = "/data/vm-domain/kvm-node4/alma-project/AlmaLinux-9-GenericCloud-latest.x86_64.qcow2"
}
...
variable "libvirt_provider" {
  default = "qemu+ssh://llops@kvm-node4/system?keyfile=/home/llops/.ssh/id_rsa"
}
variable "static_ips" {
