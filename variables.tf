...
variable "os_img-url" {
  ...
  default     = "/data/vm-domain/kvm-node3/alma-project/AlmaLinux-9-GenericCloud-latest.x86_64.qcow2"
}
...
variable "ssh_path" {
  ...
  default     = "/home/llops/.ssh/id_rsa" # no trailing slash
}
#variable "ip_type" {
  #default = "static"
#}
...
variable "libvirt_provider" {
  default = "qemu+ssh://llops@kvm-node3/system?keyfile=/home/llops/.ssh/id_rsa"
}
variable "static_ips" {
